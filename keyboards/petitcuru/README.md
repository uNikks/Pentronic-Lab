...
### 3. ロータリーエンコーダーをはんだ付けする

差し込んであるロータリーエンコーダの裏側をはんだ付けします。このとき、実際の回路に使われているのは、3ピンが横に並んでいる部分とその反対側の2ピンの部分なので、その部分のみはんだ付けし、爪ははんだ付けしなくても大丈夫です。
