...
トッププレートの四隅にキースイッチをはめ込みます．
キースイッチを上から見たときに，四角い穴が下向きになるように取り付けてください．
また，スイッチの端子が曲がっていないことを確認してください．
端子が曲がっていた場合，ペンチや指等でまっすぐに直してください．

![四隅にスイッチをはめる図](../assets/vespa/switch_plate.webp)

四隅にキースイッチを取り付けたら，トッププレートをメイン基板に重ね，スイッチの端子をソケットにはめ込みます．
キースイッチの端子が基板の穴に正しく挿入されていることを確認してください．

### 残りのスイッチを取り付ける

トッププレートとメイン基板が固定されたら，残りのキースイッチを順番に取り付けていきます．
...
次に，メイン基板裏側中央部(電池ボックスの真下に当たる部分)にゴム足を一つ取り付けます．
...
> [!TIP]
> キーボードを傾斜させたい場合，100円ショップ等で販売されているゴムシートを使用して高さを調整すると良いでしょう．
